...
class EllipseRenderer extends MultiPassRenderer
{
    ...
    {
        imagefilledellipse($image, $params['cx'], $params['cy'], (int)round($params['width']), (int)round($params['height']), $color);
    }
    ...
    protected function renderStroke($image, $params, int $color, float $strokeWidth): void
    {
        ...
        imagearc($image, $params['cx'], $params['cy'], (int)round($width), (int)round($height), 0, 360, $color);
    }
}
